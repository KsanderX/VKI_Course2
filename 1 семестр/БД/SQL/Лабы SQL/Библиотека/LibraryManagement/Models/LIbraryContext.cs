...
public partial class LIbraryContext : DbContext
{
    ...
    public void AddAuthor(Авторы author)
    {
        Авторыs.Add(author);
        SaveChanges();
    }

    public void AddBook(Книги book)
    {
        Книгиs.Add(book);
        SaveChanges();
    }

    public void AddGenre(Жанры genre)
    {
        Жанрыs.Add(genre);
        SaveChanges();
    }

    public void AddPublichers(Издательства publishers)
    {
        Издательстваs.Add(publishers);
        SaveChanges();
    }
    public void AddEmployee(СотрудникиБиблиотеки employee)
    {
        СотрудникиБиблиотекиs.Add(employee);
        SaveChanges();
    }
    public void AddReaders(Читатели readers)
    {
        Читателиs.Add(readers);
        SaveChanges();
    }
