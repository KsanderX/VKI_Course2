...
data = data.sample(frac=0.5, random_state=42)  #ИСПОЛЬЗУЕМ ТОЛЬКО 50% ДАННЫХ
...
model = Ridge(alpha=alpha, max_iter=1000) #ИЗМЕНЕНИЕ ЧИСЛА ИТЕРАЦИЙ СХОДИМОСТИ ФУНКЦИИ ОШИБКИ
